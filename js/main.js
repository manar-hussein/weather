...
{
    let wethaerInfo=await fetch(`http://api.weatherapi.com/v1/current.json?key=fffed32f803045a9a83203730231508&q=${location}`);
    let weatherForcast=await fetch(`http://api.weatherapi.com/v1/forecast.json?key=fffed32f803045a9a83203730231508&q=${location}&days=3`);
